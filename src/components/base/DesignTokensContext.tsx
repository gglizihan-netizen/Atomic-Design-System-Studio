...
interface DesignTokensContextType {
  ...
  activeTab: 'button' | 'input' | 'dropdown' | 'modal' | 'navbar' | 'icon' | 'breadcrumb' | 'pagination' | 'steps' | 'tabs' | 'datepicker' | 'slider' | 'card' | 'progress' | 'loading' | 'alert' | 'toast' | 'tag' | 'list' | 'table' | 'imageviewer' | 'skeleton' | 'sidebar' | 'appLayout';
  setActiveTab: (tab: 'button' | 'input' | 'dropdown' | 'modal' | 'navbar' | 'icon' | 'breadcrumb' | 'pagination' | 'steps' | 'tabs' | 'datepicker' | 'slider' | 'card' | 'progress' | 'loading' | 'alert' | 'toast' | 'tag' | 'list' | 'table' | 'imageviewer' | 'skeleton' | 'sidebar' | 'appLayout') => void;
}
...
export const DesignTokensProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [activeTab, setActiveTabState] = useState<'button' | 'input' | 'dropdown' | 'modal' | 'navbar' | 'icon' | 'breadcrumb' | 'pagination' | 'steps' | 'tabs' | 'datepicker' | 'slider' | 'card' | 'progress' | 'loading' | 'alert' | 'toast' | 'tag' | 'list' | 'table' | 'imageviewer' | 'skeleton' | 'sidebar' | 'appLayout'>('button');

  const setActiveTab = (tab: 'button' | 'input' | 'dropdown' | 'modal' | 'navbar' | 'icon' | 'breadcrumb' | 'pagination' | 'steps' | 'tabs' | 'datepicker' | 'slider' | 'card' | 'progress' | 'loading' | 'alert' | 'toast' | 'tag' | 'list' | 'table' | 'imageviewer' | 'skeleton' | 'sidebar' | 'appLayout') => {
